...
> Dernière mise à jour : FFBB MCP server | server.py: 1156 lignes | services.py: 3356 lignes
...
├── services/              # Logique métier modularisée (≈3356 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3356 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
