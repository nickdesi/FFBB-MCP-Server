...
> Dernière mise à jour : FFBB MCP server | server.py: 1190 lignes | services.py: 3472 lignes
...
├── services/              # Logique métier modularisée (≈3472 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3472 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
