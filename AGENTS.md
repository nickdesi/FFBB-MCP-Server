...
> Dernière mise à jour : FFBB MCP server | server.py: 2564 lignes | services.py: 10202 lignes
...
├── services/              # Logique métier modularisée (≈10202 lignes)
...
- **Modularisation** : Le package `services/` (total ≈10202 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
