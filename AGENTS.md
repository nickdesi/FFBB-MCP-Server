...
> Dernière mise à jour : FFBB MCP server | server.py: 2171 lignes | services.py: 7700 lignes
...
├── server.py              # Tools MCP + main() (≈2171 lignes)
├── services/              # Logique métier modularisée (≈7700 lignes)
...
- **Modularisation** : Le package `services/` (total ≈7700 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
