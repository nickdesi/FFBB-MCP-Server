...
> Dernière mise à jour : FFBB MCP server | server.py: 2564 lignes | services.py: 10245 lignes
...
├── services/              # Logique métier modularisée (≈10245 lignes)
...
- **Modularisation** : Le package `services/` (total ≈10245 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
