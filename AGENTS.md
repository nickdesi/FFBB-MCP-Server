...
> Dernière mise à jour : FFBB MCP server | server.py: 1238 lignes | services.py: 4137 lignes
...
├── server.py              # Tools MCP + main() (≈1238 lignes)
├── services/              # Logique métier modularisée (≈4137 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4137 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
