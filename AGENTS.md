...
> Dernière mise à jour : FFBB MCP server | server.py: 1792 lignes | services.py: 6054 lignes
...
├── services/              # Logique métier modularisée (≈6054 lignes)
...
- **Modularisation** : Le package `services/` (total ≈6054 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
