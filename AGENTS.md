...
> Dernière mise à jour : FFBB MCP server | server.py: 1277 lignes | services.py: 4291 lignes
...
├── services/              # Logique métier modularisée (≈4291 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4291 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
