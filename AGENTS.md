...
> Dernière mise à jour : FFBB MCP server | server.py: 2585 lignes | services.py: 10217 lignes
...
├── services/              # Logique métier modularisée (≈10217 lignes)
...
- **Modularisation** : Le package `services/` (total ≈10217 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
