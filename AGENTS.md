...
> Dernière mise à jour : FFBB MCP server | server.py: 1233 lignes | services.py: 3940 lignes
...
├── services/              # Logique métier modularisée (≈3940 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3940 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
