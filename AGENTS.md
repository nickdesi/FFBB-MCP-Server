...
> Dernière mise à jour : FFBB MCP server | server.py: 2511 lignes | services.py: 9937 lignes
...
├── services/              # Logique métier modularisée (≈9937 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9937 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
