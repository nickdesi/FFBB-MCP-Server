...
> Dernière mise à jour : FFBB MCP server | server.py: 2384 lignes | services.py: 9318 lignes
...
├── server.py              # Tools MCP + main() (≈2384 lignes)
├── services/              # Logique métier modularisée (≈9318 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9318 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
