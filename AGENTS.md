...
> Dernière mise à jour : FFBB MCP server | server.py: 428 lignes | services.py: 10420 lignes
...
├── services/              # Logique métier modularisée (≈10420 lignes)
...
- **Modularisation** : Le package `services/` (total ≈10420 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
