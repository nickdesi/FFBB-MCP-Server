...
> Dernière mise à jour : FFBB MCP server | server.py: 1193 lignes | services.py: 3610 lignes
...
├── services/              # Logique métier modularisée (≈3610 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3610 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
