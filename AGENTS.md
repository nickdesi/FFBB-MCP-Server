...
> Dernière mise à jour : FFBB MCP server | server.py: 1326 lignes | services.py: 4437 lignes
...
├── server.py              # Tools MCP + main() (≈1326 lignes)
├── services/              # Logique métier modularisée (≈4437 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4437 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
