...
> Dernière mise à jour : FFBB MCP server | server.py: 1238 lignes | services.py: 4177 lignes
...
├── services/              # Logique métier modularisée (≈4177 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4177 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
