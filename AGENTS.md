...
> Dernière mise à jour : FFBB MCP server | server.py: 2064 lignes | services.py: 6734 lignes
...
├── server.py              # Tools MCP + main() (≈2064 lignes)
├── services/              # Logique métier modularisée (≈6734 lignes)
...
- **Modularisation** : Le package `services/` (total ≈6734 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
