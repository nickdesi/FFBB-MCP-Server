...
> Dernière mise à jour : FFBB MCP server | server.py: 2437 lignes | services.py: 9415 lignes
...
├── server.py              # Tools MCP + main() (≈2437 lignes)
├── services/              # Logique métier modularisée (≈9415 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9415 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
