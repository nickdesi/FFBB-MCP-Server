...
> Dernière mise à jour : FFBB MCP server | server.py: 1298 lignes | services.py: 4362 lignes
...
├── server.py              # Tools MCP + main() (≈1298 lignes)
├── services/              # Logique métier modularisée (≈4362 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4362 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
