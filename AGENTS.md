...
> Dernière mise à jour : FFBB MCP server | server.py: 1277 lignes | services.py: 4212 lignes
...
├── server.py              # Tools MCP + main() (≈1277 lignes)
├── services/              # Logique métier modularisée (≈4212 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4212 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
