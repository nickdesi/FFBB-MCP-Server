...
> Dernière mise à jour : FFBB MCP server | server.py: 2064 lignes | services.py: 6740 lignes
...
├── services/              # Logique métier modularisée (≈6740 lignes)
...
- **Modularisation** : Le package `services/` (total ≈6740 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
