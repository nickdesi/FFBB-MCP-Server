...
> Dernière mise à jour : FFBB MCP server | server.py: 2427 lignes | services.py: 9403 lignes
...
├── server.py              # Tools MCP + main() (≈2427 lignes)
├── services/              # Logique métier modularisée (≈9403 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9403 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
