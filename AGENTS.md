...
> Dernière mise à jour : FFBB MCP server | server.py: 1670 lignes | services.py: 5592 lignes
...
├── server.py              # Tools MCP + main() (≈1670 lignes)
├── services/              # Logique métier modularisée (≈5592 lignes)
...
- **Modularisation** : Le package `services/` (total ≈5592 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
