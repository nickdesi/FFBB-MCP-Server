...
> Dernière mise à jour : FFBB MCP server | server.py: 1265 lignes | services.py: 4171 lignes
...
├── server.py              # Tools MCP + main() (≈1265 lignes)
├── services/              # Logique métier modularisée (≈4171 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4171 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
