...
> Dernière mise à jour : FFBB MCP server | server.py: 1193 lignes | services.py: 3757 lignes
...
├── server.py              # Tools MCP + main() (≈1193 lignes)
├── services/              # Logique métier modularisée (≈3757 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3757 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
