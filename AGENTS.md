...
> Dernière mise à jour : FFBB MCP server | server.py: 2384 lignes | services.py: 9332 lignes
...
├── services/              # Logique métier modularisée (≈9332 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9332 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
