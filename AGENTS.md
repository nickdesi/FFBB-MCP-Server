...
> Dernière mise à jour : FFBB MCP server | server.py: 1209 lignes | services.py: 3837 lignes
...
├── services/              # Logique métier modularisée (≈3837 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3837 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
