...
> Dernière mise à jour : FFBB MCP server | server.py: 1473 lignes | services.py: 5158 lignes
...
├── server.py              # Tools MCP + main() (≈1473 lignes)
├── services/              # Logique métier modularisée (≈5158 lignes)
...
- **Modularisation** : Le package `services/` (total ≈5158 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
