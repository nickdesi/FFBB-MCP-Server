...
> Dernière mise à jour : FFBB MCP server | server.py: 1173 lignes | services.py: 3445 lignes
...
├── services/              # Logique métier modularisée (≈3445 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3445 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
