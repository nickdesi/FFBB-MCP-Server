...
> Dernière mise à jour : FFBB MCP server | server.py: 1190 lignes | services.py: 3516 lignes
...
├── server.py              # Tools MCP + main() (≈1190 lignes)
├── services/              # Logique métier modularisée (≈3516 lignes)
...
- **Modularisation** : Le package `services/` (total ≈3516 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
