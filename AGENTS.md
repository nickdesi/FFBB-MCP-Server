...
> Dernière mise à jour : FFBB MCP server | server.py: 2071 lignes | services.py: 6836 lignes
...
├── services/              # Logique métier modularisée (≈6836 lignes)
...
- **Modularisation** : Le package `services/` (total ≈6836 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
