...
> Dernière mise à jour : FFBB MCP server | server.py: 2438 lignes | services.py: 9644 lignes
...
├── server.py              # Tools MCP + main() (≈2438 lignes)
├── services/              # Logique métier modularisée (≈9644 lignes)
...
- **Modularisation** : Le package `services/` (total ≈9644 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
