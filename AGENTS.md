...
> Dernière mise à jour : FFBB MCP server | server.py: 1381 lignes | services.py: 4916 lignes
...
├── server.py              # Tools MCP + main() (≈1381 lignes)
├── services/              # Logique métier modularisée (≈4916 lignes)
...
- **Modularisation** : Le package `services/` (total ≈4916 lignes) remplace l'ancien fichier unique de 2915 lignes pour une meilleure cohésion.
