...
def register_prompts(mcp):
    ...
    def expert_basket() -> str:
        ...
        return (
            ...
            "   - Ce tool a été spécialement conçu et optimisé pour récupérer TOUS les matchs (passés avec scores, et futurs) de manière fiable.\n"
            ...
            "2. Liste ses équipes → `ffbb_equipes_club(organisme_id, filtre=categorie)` — chaque équipe a un `poule_id`\n"
