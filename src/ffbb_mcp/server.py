...
async def index(request: Request) -> Response:
    ...
    <body class="flex flex-col items-center justify-center min-h-screen p-4 text-center">
        ...
        <div class="flex gap-4">
            <a href="https://github.com/nickdesi/FFBB-MCP-Server" target="_blank" class="px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-lg text-white font-semibold transition-colors">GitHub</a>
            <a href="https://smithery.ai/servers/nickdesi/mcpffbb" target="_blank" class="px-6 py-3 bg-[#e2693e] hover:bg-[#c95d37] rounded-lg text-white font-semibold transition-colors">Available on Smithery</a>
        </div>
