...
Nous utilisons le framework `mcp.server.mcpserver` (SDK `mcp 2.2.0+`, spec `2026-07-28`) pour simplifier la définition des outils, prompts et ressources. Il gère la sérialisation JSON-RPC et la validation des types via **Pydantic**.
