...
### Fixed
- **CI/CD & PyPI Release Resiliency** : Ajout du flag `--check-url https://pypi.org/simple/` dans le workflow `release.yml` pour ignorer proprement les doublons et parer aux échecs de ré-upload PyPI HTTP 400.
- Synchronisation complète de la release `1.14.1` incluant les optimisations TDQS 17/17 A et `glama.json`.
